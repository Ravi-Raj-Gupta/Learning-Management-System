...
const CallToAction = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0 '>
      ...
      <p className='text-gray-500 sm:text-sm'>Empower your future with world-class courses designed by industry experts. Upgrade your skills, unlock new opportunities, and achieve your personal and professional goals.</p>
